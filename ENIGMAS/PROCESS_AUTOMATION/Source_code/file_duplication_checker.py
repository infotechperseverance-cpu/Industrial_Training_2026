...
''' this module give final name of file if any duplication but name only, not create file
 ...
 this module check name file first then created new file is not follow ,
 this module required filename with extension'''
...
def validate_filename(filename):
    ...
    pattern = (
        ...
        r"pdf|docx|xlsx|pptx|txt|csv|json|xml|"   # Documents & Data
