...
from Connection_Module import create_tables
...
def update_product(db_connection):
    ...
    while True:
        try:
            ...
            if product_data is not None:
                ...
                print(f"Product id {productId} not Found, please enter Valid product id ")
        except ValueError:
            print("ERROR: product_id must be integer")
    ...
    ch=input("Enter option 1-5: ").strip()
