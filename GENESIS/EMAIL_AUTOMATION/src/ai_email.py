...
# DESCRIPTION : This module generates professional emails using Google Gemini AI.
# FEATURES    :
#   1. Generate email subject
#   2. Generate email body
#   3. Supports different tones
#   4. Returns generated email to main program
# IMPORTANT   : Draft saving is handled by main.py.
# =============================================================================
...
# PURPOSE    : Handles communication with Gemini AI model.
# =============================================================================
class AIEmailWriter:
...
if __name__ == "__main__":
    ...
    details = input("Enter Email Details : ")
