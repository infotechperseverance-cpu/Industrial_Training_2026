# =============================================================================
# FILE NAME   : approval_flow.py
# PROJECT     : Email Automation System
# MODULE      : Email Approval Workflow System
# DESCRIPTION : This module allows users to submit emails for approval.
#               Manager can approve/reject emails.
#               Approved emails are sent through Gmail SMTP.
# DATABASE    : email_automation
# TABLES      : email_approvals, email_reports
# =============================================================================
...
# PURPOSE       : Creates MySQL database connection.
...
# PURPOSE       : Creates required tables (email_approvals, email_reports).
# =============================================================================
def create_tables():
    conn = db_connection()
    if conn is None:
...
# PURPOSE       : Submits an email request for manager approval.
# =============================================================================
def request_email_approval(sender_email):
    ...
    try:
        ...
        (sender_email, receiver_email, subject, body, status)
...
# PURPOSE       : Displays all pending email requests.
# RETURNS       : Selected email details list
# =============================================================================
def view_pending_emails():
    ...
    try:
        ...
        cursor.execute("""
        SELECT id, sender_email, receiver_email, subject, body
...
# PURPOSE       : Gets selected pending email details by request ID.
# =============================================================================
def get_email_request(request_id):
    ...
    try:
        ...
        cursor.execute("""
        SELECT sender_email, receiver_email, subject, body
        FROM email_approvals
...
# PURPOSE       : Saves approved email details into email_reports table.
# =============================================================================
...
# PURPOSE       : Updates approval request status.
# =============================================================================
...
# PURPOSE       : Sends approved email through Gmail SMTP.
# =============================================================================
def send_approved_email(sender_email, app_password, receiver_email, subject, body):
    try:
        email = EmailMessage()
...
# PURPOSE       : Manager approves or rejects email requests.
# =============================================================================
def manager_panel(manager_email, manager_password):
    ...
    if action == "A":
        ...
        if result:
            ...
            save_email_report(receiver, subject, "Success")
            print("\nEmail Approved and Sent Successfully.")
        else:
            update_status(request_id, "Failed")
            save_email_report(receiver, subject, "Failed")
...
# PURPOSE       : Main approval module menu.
# =============================================================================
def approval_workflow_menu(user_email=None, password=None):
    if user_email is None:
        user_email = input("Enter Gmail ID : ")
    ...
    while True:
        ...
        if choice == "1":
            request_email_approval(user_email)

        elif choice == "2":
            manager_panel(user_email, password)
