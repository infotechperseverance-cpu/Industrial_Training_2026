...
# MODULE      : Attachment Management System
# DESCRIPTION : This module manages email attachments.
# FEATURES    :
...
# USED WITH   : send_email.py, bulk_email.py, draft_management.py
# =============================================================================
...
# PURPOSE    : Handles email file attachments.
# =============================================================================
class AttachmentManager:

    # =========================================================================
    # FUNCTION NAME : add_attachment
    # PURPOSE       : Adds one file attachment to email object.
    # =========================================================================
    def add_attachment(self, email, file_path):
        ...
        try:
            ...
            print("Attachment Added Successfully:", file_name)
            return True
    ...
    # PURPOSE       : Adds multiple files to email.
    # =========================================================================
    def add_multiple_attachments(self, email, file_paths):
        ...
        for file_path in file_paths:
            result = self.add_attachment(email, file_path)
            if result:
                success += 1

        print(f"{success} Attachment(s) Added.")
        return success > 0
