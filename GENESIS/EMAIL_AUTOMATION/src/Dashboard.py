...
#
# DESCRIPTION:
# Displays email analytics from MySQL database.
#
# CALL FROM:
# main.py
#
...
class EmailAnalytics:
    ...
    def dashboard(self):
        ...
        try:
            ...
            print(
                f"Successful Emails     : {success}"
            )


            print(
                f"Failed Emails         : {failed}"
            )
            ...
            print(
                f"Today's Emails        : {today}"
            )


            print(
                f"This Week Emails      : {weekly}"
            )


            print(
                f"This Month Emails     : {monthly}"
            )
            ...
            print(
                f"Saved Drafts          : {drafts}"
            )


            print(
                f"Email Reminders       : {reminders}"
            )
