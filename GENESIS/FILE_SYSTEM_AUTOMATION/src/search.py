...
main = os.path.join(BASE_DIR, "File_Manager")
FILE_DATA = os.path.join(main, "file_data.json")
BACKUP_LOG = os.path.join(BASE_DIR, "backup_log.json")
SEARCH_HISTORY = os.path.join(BASE_DIR, "search_history.json")
# ------------------------------------------------------------------------
...
def search_menu():
    while True:
        ...
        match choice:
            case 1: search_by_filename()
            case 2: search_by_partial_name()
            case 3: search_by_extension()
            case 4: search_by_category()
            case 5: search_by_size()
            case 6: recent_files()
            case 7: recent_backups()
            case 8: display_history()
