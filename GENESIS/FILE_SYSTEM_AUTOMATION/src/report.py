...
# File paths
file = os.path.join("File_Manager", "file_data.json")
...
def generate_report():
    ...
    for item in files:
        ...
        path = os.path.join("File_Manager", category, filename)
...
def display_weekly_report(report):
    ...
    print("Total Storage Used :",
          report["storage_summary"]["total_storage_used"], "Bytes")

    print("Largest File :",
          report["storage_summary"]["largest_file"])

    print("Largest File Size :",
          report["storage_summary"]["largest_file_size"], "Bytes")
